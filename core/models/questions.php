...
class Question {
    ...
    function __construct($arg = null){
        ...
        $this->table_name = DB_TBL_PREFIX . "questions";
        ...
        if(isset($arg)){
            ...
            if($arg_type == 'integer'){
                ...
                $user = $this->db->select($this->table_name, 'question_content', $arg);
            }
            ...
            $this->fields['question_content'] = $user[0]['question_content'];
    ...
    private function createEmptyQuestion(){
    ...
    function delete(){
        ...
        if($this->fields['id'] == ''){
            error_log('Unable to delete question.  No Question ID Provided');
        } else {
